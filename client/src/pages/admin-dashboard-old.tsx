...
import { Upload, LogOut, Edit, Type, Save, Image as ImageIcon } from "lucide-react";
...
const websiteImages = [
  ...
  {
    id: "services-1",
    title: "Healing in Quiet Corner",
    currentUrl: "https://images.unsplash.com/photo-1481627834876-b7833e8f5570?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=300&h=200",
    description: "Book, glasses, candle creating peaceful therapy moment",
    section: "Services Section",
    altText: "Healing begins in quiet corner - book, glasses, candle creating peaceful therapy moment"
  },
  {
    id: "services-2", 
    title: "Connection Support",
    currentUrl: "https://images.unsplash.com/photo-1516575334481-f85287c2c82d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=300&h=200",
    description: "Phone connection showing therapeutic support accessibility",
    section: "Services Section",
    altText: "It's ok to reach out - phone connection showing therapeutic support accessibility"
  },

  // Approach Section Images
  {
    id: "approach-1",
    title: "Peaceful Therapy Session",
    currentUrl: "https://images.unsplash.com/photo-1544027993-37dbfe43562a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=300&h=200",
    description: "Gentle side-view creating safe therapeutic space",
    section: "Approach Section",
    altText: "Peaceful therapy session with gentle side-view of therapist creating safe space"
  },
  {
    id: "approach-2",
    title: "Mountain Reflection Therapy", 
    currentUrl: "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?ixlib=rb-4.0.3&ixid=M3wxMJA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=300&h=200",
    description: "Calming therapy environment with peaceful atmosphere",
    section: "Approach Section",
    altText: "Calming therapy environment with soft lighting and peaceful atmosphere"
  },
  {
    id: "approach-3",
    title: "Gentle Therapy Space",
    currentUrl: "https://images.unsplash.com/photo-1518611012118-696072aa579a?ixlib=rb-4.0.3&ixid=M3wxMJA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=300&h=200", 
    description: "Warm, welcoming therapeutic environment",
    section: "Approach Section",
    altText: "Gentle therapy space with warm, welcoming therapeutic environment"
  },
  ...
  // After Therapy Section Images
  {
    ...
    currentUrl: "https://images.unsplash.com/photo-1441974231531-c6227db76b6e?ixlib=rb-4.0.3&ixid=M3wxMJA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=400&h=300",
    description: "Forest path representing healing journey",
    section: "After Therapy Section", 
    altText: "Forest path representing the healing journey and personal growth"
  },
  {
    id: "after-therapy-2",
    title: "Peaceful Reflection",
    currentUrl: "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=400&h=300",
...
export default function AdminDashboard() {
  ...
  const textMutation = useMutation({
    mutationFn: async ({ blockKey, content, title }: { blockKey: string; content: string; title: string }) => {
      const response = await apiRequest("/api/content", "POST", {
        blockKey,
        title,
        content,
        blockType: "text",
    ...
    <div className="min-h-screen misty-sage-bg">
      <div className="container mx-auto px-6 py-8">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex justify-center">
                      <ObjectUploader
                        ...
                        onGetUploadParameters={handleGetUploadParameters}
                        onComplete={handleUploadComplete(image.id)}
                        buttonClassName="bg-sage-green hover:bg-olive-green text-white px-4 py-2 rounded-lg font-medium transition-all duration-300 flex items-center space-x-2 text-sm"
                      >
                        <Upload className="h-4 w-4" />
                    ...
                    {uploadMutation.isPending && (
                      <div className="text-center py-2">
                        <div className="w-4 h-4 border-2 border-sage-green border-t-transparent rounded-full animate-spin mx-auto mb-2"></div>
                        <p className="text-xs text-charcoal-grey">Uploading...</p>
                      </div>
                    )}
                  </CardContent>
                </Card>
        ...
        <Card className="mt-8 bg-white/60 backdrop-blur-sm border-sage-green/20">
          ...
          <CardContent>
            <div className="space-y-3 text-charcoal-grey">
              <p>1. Click "Upload New Image" on any image card above</p>
              <p>2. Select your image file (JPG, PNG, or other image formats)</p>
              <p>3. The image will be uploaded and automatically replace the current one</p>
              <p>4. Your website will immediately show the new image</p>
              <div className="mt-4 p-3 bg-sage-green/10 rounded-lg">
                <p className="text-sm">
                  <strong>Tip:</strong> For best results, use high-quality images that match the mood and style of your therapy practice. 
