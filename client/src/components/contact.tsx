            ...
            <div className="relative bg-gradient-to-br from-sage-green/10 via-white/70 to-peach-blush/15 backdrop-blur-sm p-10 rounded-3xl shadow-warm border border-sage-green/20 overflow-hidden">
              ...
              <div className="relative z-10 text-center space-y-6">
                ...
                <div className="flex flex-col items-center space-y-4">
                  <WhatsAppButton className="text-white px-10 py-4 text-lg font-medium rounded-2xl shadow-warm hover:shadow-strong transition-all duration-300 transform hover:scale-105">
                    Begin Your Journey
                  </WhatsAppButton>
